...
export const Projects = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-fredericka text-orange-600">
        {t("projects.title")}
      </h1>
      <section className="flex flex-col h-full w-full justify-start items-center">
        <section className="flex gap-5 font-poppins text-lg text-red-700 font-normal h-auto">
          <button
            onClick={onDevProjects}
            className={`pb-1 px-2 hover:text-amber-500 ${
              onDev
                ? "border border-solid border-red-700  border-x-0 border-t-0"
                : "border-none"
            }`}
          >
